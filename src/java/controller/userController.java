...
public class userController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        UserVO userVO = new UserVO(identificacion, nombre, apellido, direccion, telefono, correo, clave);
        UserDAO userDAO = new UserDAO(userVO);
        
        switch(option){
            
            //Insercion de usuario tipo cliente
            case 1:
                if(userDAO.insert()){
                    request.setAttribute("mensajeExito", "Se ha registrado correctamente el usuario");
